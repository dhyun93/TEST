import {
  ...
  EvaluationData,
  FrequencyStep1Row,
  FrequencyRiskDataRow,
  FrequencyStep3Row,
  ThreeStep1Row,
  ThreeStepRiskDataRow,
  ThreeStep3Row,
  ChemicalEditableRow,
  ChecklistSection,
  ProcessRow,
...
export const evaluationListMockData: EvaluationData[] = [
  ...
  },
  {
    id: 4,
    year: 2025,
    title: "고소 작업(Master Roller) 정기 위험성 평가",
    type: "정기평가",
    method: "정량적 평가",
    regulation: "산안법 제37조",
...
export const frequencyStep1MockData: FrequencyStep1Row[] = [
  {
    id: 1,
    work: "슬래그 밀 정비",
    hazard: "슬래그 미분 분진 흡입으로 인한 호흡기 질환 위험",
    law: "산업안전보건법 제32조(보호구의 지급 등)",
    action: "- 특급 방진마스크 지급 및 착용 철저\n- 작업 전 습식 살수 실시",
    proof: null,
  },
  {
    id: 2,
    work: "밀폐공간 점검",
    hazard: "인렛 슈트 내부 유해가스 및 산소 결핍에 의한 질식 위험",
    law: "산업안전보건법 제39조(보건조치)",
    action: "- 작업 전 산소농도 및 유해가스 측정\n- 송기마스크 착용 및 환기팬 가동",
    proof: null,
  },
  {
    id: 3,
    work: "유압라인 보수",
    hazard: "고압 호스 파손 및 고온 오일 분출로 인한 화상 위험",
    law: "산업안전보건법 제38조(안전조치)",
    action: "- 유압 펌프 정지 및 잔압(0 bar) 확인\n- 내열 장갑 및 보안면 착용",
    proof: null,
  },
  {
    id: 4,
    work: "설비 전원 차단",
    hazard: "작업 중 설비 불시 가동으로 인한 협착(끼임) 위험",
    law: "산업안전보건법 제38조(안전조치)",
    action: "- LOTOTO 절차 준수 및 잠금장치 설치\n- 기동 스위치 조작 금지 표지 부착",
    proof: null,
  },
  {
    id: 5,
    work: "고소 작업",
    hazard: "2m 이상 높이에서 작업 중 추락 위험",
    law: "산업안전보건법 제38조(안전조치)",
    action: "- 안전대(Safety Belt) 체결 및 이중 고리 사용\n- 작업 발판 고정 상태 확인",
    proof: null,
  },
  {
    id: 6,
    work: "중량물 인양",
    hazard: "체인블럭 및 호이스트 줄걸이 불량으로 낙하 위험",
    law: "산업안전보건법 제38조(안전조치)",
    action: "- 정격 하중 준수 및 줄걸이 상태 점검\n- 인양물 하부 출입 금지",
    proof: null,
  },
  {
    id: 7,
    work: "전기 패널 점검",
    hazard: "활선 근접 작업 시 충전부 접촉으로 인한 감전 위험",
    law: "산업안전보건법 제38조(안전조치)",
    action: "- 절연 장갑 및 절연화 착용\n- 정전 작업 원칙 준수",
    proof: null,
  },
  {
    id: 8,
    work: "화기 작업",
    hazard: "용접/용단 불티 비산으로 인한 주변 가연물 화재 위험",
    law: "산업안전보건법 제23조(안전조치)",
    action: "- 불티 비산 방지포 설치\n- 소화기 2대 이상 근접 비치",
    proof: null,
  },
  {
    id: 9,
    work: "현장 소음 노출",
    hazard: "밀(Mill) 가동 소음으로 인한 소음성 난청 위험",
    law: "산업안전보건법 제167조(청력보전프로그램)",
    action: "- 귀마개 등 청력보호구 올바른 착용\n- 저소음 작업 방법 적용",
    proof: null,
  },
  {
    id: 10,
    work: "지게차 운반",
    hazard: "지게차 운행 중 보행자 충돌 및 자재 전도 위험",
    law: "산업안전보건법 제38조(안전조치)",
    action: "- 사내 제한속도(10km/h) 준수\n- 유도자 배치 및 신호수 운영",
    proof: null,
  },
  {
    id: 11,
    work: "컨베이어 정비",
    hazard: "회전체(롤러)에 신체 말림 및 끼임 위험",
    law: "산업안전보건법 제87조(방호조치)",
    action: "- 회전체 방호 덮개 설치 확인\n- 비상정지 스위치 작동 테스트",
    proof: null,
  },
  { id: 12, work: "어큐뮬레이터 교체", hazard: "질소 가스 누출 및 고압 폭발 위험", law: "산업안전보건법 제38조(안전조치)", action: "- 내부 질소 압력 완전 제거 확인\n- 전용 공구 사용", proof: null },
  {
    id: 13,
    work: "작업장 이동",
    hazard: "바닥 오일 및 자재로 인한 미끄러짐/넘어짐 위험",
    law: "산업안전보건법 제3조(사업주 의무)",
    action: "- 통로상 장애물 제거 및 5S 활동\n- 미끄럼 방지 안전화 착용",
    proof: null,
  },
]
...
export const frequencyStep2MockData: FrequencyRiskDataRow[] = [
  {
    ...
    afterPhoto: null,
    evaluator: "이효성",
    evaluationDate: new Date("2025-10-27"),
  },
  {
    id: 2,
    work: "밀폐공간 점검",
    hazard: "인렛 슈트 내부 유해가스 및 산소 결핍에 의한 질식 위험",
    action: "- 작업 전 산소농도 측정 및 환기 실시",
    attachmentFile: null,
    frequency: 2,
    intensity: 4,
    afterPhoto: null,
  ...
  },
  {
    ...
    work: "유압라인 보수",
    hazard: "고압 호스 파손 및 고온 오일 분출로 인한 화상 위험",
    action: "- 잔압 제거 및 내열 보호구 착용",
    attachmentFile: null,
    frequency: 2,
    intensity: 3,
    afterPhoto: null,
    evaluator: "최승휴",
    evaluationDate: new Date("2025-10-28"),
  },
  {
    id: 4,
    work: "설비 전원 차단",
    hazard: "작업 중 설비 불시 가동으로 인한 협착(끼임) 위험",
    action: "- LOTOTO 실시 및 키 관리 철저",
    attachmentFile: null,
    frequency: 3,
    intensity: 4,
    afterPhoto: null,
  ...
  },
  {
    ...
    work: "고소 작업",
    hazard: "2m 이상 높이에서 작업 중 추락 위험",
    action: "- 안전대 착용 및 생명줄 체결",
    attachmentFile: null,
    frequency: 3,
    intensity: 3,
    afterPhoto: null,
    evaluator: "양강현",
    evaluationDate: new Date("2025-10-29"),
  },
  {
    id: 6,
    work: "중량물 인양",
    hazard: "체인블럭 및 호이스트 줄걸이 불량으로 낙하 위험",
    action: "- 줄걸이 상태 점검 및 하부 통제",
    attachmentFile: null,
    frequency: 2,
    intensity: 3,
    afterPhoto: null,
  ...
  },
  {
    ...
    work: "화기 작업",
    hazard: "용접/용단 불티 비산으로 인한 주변 가연물 화재 위험",
    action: "- 화기 감시자 배치 및 소화기 비치",
    attachmentFile: null,
    frequency: 2,
    intensity: 3,
    afterPhoto: null,
    evaluator: "박소장",
    evaluationDate: new Date("2025-10-30"),
  },
  {
    id: 9,
    work: "현장 소음 노출",
    hazard: "밀(Mill) 가동 소음으로 인한 소음성 난청 위험",
    action: "- 청력보호구(귀마개) 착용 생활화",
    attachmentFile: null,
    frequency: 3,
    intensity: 2,
    afterPhoto: null,
  ...
  },
  {
    ...
    work: "컨베이어 정비",
    hazard: "회전체(롤러)에 신체 말림 및 끼임 위험",
    action: "- 가동 중 접근 금지 및 방호덮개 점검",
    attachmentFile: null,
    frequency: 2,
    intensity: 2,
    afterPhoto: null,
    evaluator: "문반장",
    evaluationDate: new Date("2025-10-31"),
  },
  {
    id: 12,
    work: "어큐뮬레이터 교체",
    hazard: "질소 가스 누출 및 고압 폭발 위험",
    action: "- 압력 제거 확인 프로세스 준수",
    attachmentFile: null,
    frequency: 1,
    intensity: 4,
    afterPhoto: null,
...
export const frequencyStep3MockData: FrequencyStep3Row[] = [
  {
    ...
    work: "슬래그 밀 정비",
    hazard: "슬래그 미분 분진 흡입으로 인한 호흡기 질환 위험",
    action: "특급 방진마스크 전원 지급 완료 및 작업 전 살수 조치 시행",
    plannedDate: new Date("2025-10-27"),
    completedDate: new Date("2025-10-27"),
    evaluator: "이효성",
    frequency: 1,
    intensity: 2,
    afterPhoto: null,
  },
  {
    ...
    work: "밀폐공간 점검",
    hazard: "인렛 슈트 내부 유해가스 및 산소 결핍에 의한 질식 위험",
    action: "산소농도 21% 확인 및 송풍기 상시 가동 조치",
    plannedDate: new Date("2025-10-27"),
    completedDate: new Date("2025-10-27"),
    evaluator: "이호성",
    frequency: 1,
  ...
  },
  {
    ...
    work: "유압라인 보수",
    hazard: "고압 호스 파손 및 고온 오일 분출로 인한 화상 위험",
    action: "압력 게이지 0 확인 후 분해 작업 진행, 보안면 착용 확인",
    plannedDate: new Date("2025-10-28"),
  ...
  },
  {
    ...
    work: "설비 전원 차단",
    hazard: "작업 중 설비 불시 가동으로 인한 협착(끼임) 위험",
    action: "MCC룸 차단기 LOTO 설치 및 작업자 전원 자물쇠 체결 확인",
    plannedDate: new Date("2025-10-28"),
    completedDate: new Date("2025-10-28"),
    evaluator: "최승휴",
    frequency: 1,
  ...
  },
  {
    ...
    work: "고소 작업",
    hazard: "2m 이상 높이에서 작업 중 추락 위험",
    action: "안전대 걸이 시설물 보강 및 안전대 착용 상태 교차 점검",
    plannedDate: new Date("2025-10-29"),
    completedDate: new Date("2025-10-29"),
    evaluator: "양강현",
    frequency: 1,
    intensity: 3,
    afterPhoto: null,
  },
  {
    ...
    work: "중량물 인양",
    hazard: "체인블럭 및 호이스트 줄걸이 불량으로 낙하 위험",
    action: "줄걸이 용구(슬링벨트) 손상 여부 점검 후 작업 승인",
    plannedDate: new Date("2025-10-29"),
    completedDate: new Date("2025-10-29"),
    evaluator: "양재훈",
    frequency: 1,
  ...
  },
  {
    ...
    work: "전기 패널 점검",
    hazard: "활선 근접 작업 시 충전부 접촉으로 인한 감전 위험",
    action: "특고압 절연장갑 지급 및 검전기 작동 확인",
    plannedDate: new Date("2025-10-29"),
    completedDate: new Date("2025-10-29"),
    evaluator: "김반장",
    frequency: 1,
  ...
  },
  {
    ...
    work: "화기 작업",
    hazard: "용접/용단 불티 비산으로 인한 주변 가연물 화재 위험",
    action: "불티 비산 방지포 틈새 없이 설치 및 살수 준비 완료",
  ...
  },
  {
    ...
    work: "현장 소음 노출",
    hazard: "밀(Mill) 가동 소음으로 인한 소음성 난청 위험",
    action: "소음 측정 실시 및 귀마개 착용 교육(TBM) 진행",
    plannedDate: new Date("2025-10-30"),
    completedDate: new Date("2025-10-30"),
    evaluator: "이효성",
    frequency: 2,
  ...
  },
  {
    ...
    work: "지게차 운반",
    hazard: "지게차 운행 중 보행자 충돌 및 자재 전도 위험",
    action: "지게차 후방 카메라 작동 확인 및 작업 반경 내 접근 금지 테이핑",
    plannedDate: new Date("2025-10-30"),
    completedDate: new Date("2025-10-30"),
    evaluator: "정감독",
    frequency: 1,
  ...
  },
  {
    ...
    work: "컨베이어 정비",
    hazard: "회전체(롤러)에 신체 말림 및 끼임 위험",
    action: "작업 구간 비상 정지 밧줄 스위치(Pull Cord) 작동 상태 점검",
    plannedDate: new Date("2025-10-31"),
    completedDate: new Date("2025-10-31"),
    evaluator: "문반장",
    frequency: 1,
    intensity: 2,
    afterPhoto: null,
  },
  {
    ...
    work: "어큐뮬레이터 교체",
    hazard: "질소 가스 누출 및 고압 폭발 위험",
    action: "매니폴드 블록 압력 제로화 확인 및 안전 캡 장착",
    plannedDate: new Date("2025-10-31"),
    completedDate: new Date("2025-10-31"),
    evaluator: "서반장",
    frequency: 1,
  ...
  },
  {
    ...
    work: "작업장 이동",
    hazard: "바닥 오일 및 자재로 인한 미끄러짐/넘어짐 위험",
    action: "오일 흡착포 이용 바닥 청소 완료 및 통행로 확보",
    plannedDate: new Date("2025-10-31"),
    completedDate: new Date("2025-10-31"),
    evaluator: "장감독",
    frequency: 1,
...
export const chemicalStep1MockData: ChemicalEditableRow[] = [
  {
    ...
    process: "부품 세정",
    product: "기어/베어링",
    substance: "메틸에틸케톤(MEK)",
    exposure: "증기 흡입 및 피부 접촉",
    toxicity: "호흡기 자극/신경계 영향",
    risk: 3,
    action: "국소배기장치 가동 철저 및 방독마스크 착용",
    image: null,
  },
  {
    id: 2,
    process: "유압 정비",
    product: "유압 라인",
    substance: "광유(Mineral Oil)",
    exposure: "오일 미스트 흡입",
    toxicity: "피부염 유발/폐 질환",
    risk: 2,
    action: "내유성 장갑 착용 및 오일 미스트 제거 설비 확인",
    image: null,
  },
  {
    id: 3,
    ...
    substance: "용접 흄(망간)",
    exposure: "고농도 흄 흡입",
    toxicity: "신경독성/폐기능 저하",
    risk: 3,
    action: "이동식 흄 집진기 설치 및 특급 방진마스크 착용",
    image: null,
  },
  {
    id: 4,
    ...
    substance: "자일렌/톨루엔",
    exposure: "유기용제 증기 흡입",
    toxicity: "중추신경 억제/인화성",
    risk: 3,
    action: "방폭 환기팬 설치 및 송기마스크(또는 방독) 착용",
    image: null,
  },
  {
    id: 5,
    ...
    product: "지게차",
    substance: "황산",
    exposure: "전해액 비산 및 접촉",
    toxicity: "화학적 화상/부식성",
    risk: 3,
    action: "보안면(Face Shield) 및 내산 장갑/앞치마 착용",
    image: null,
  },
  {
    id: 6,
    ...
    toxicity: "발암성(1급)/진폐증",
    risk: 2,
    action: "습식 작업 원칙 준수 및 살수 설비 상시 가동",
    image: null,
  },
  {
    id: 7,
    ...
    toxicity: "피부 과민 반응",
    risk: 1,
    action: "불침투성 보호장갑 착용 및 작업 후 손 세척 철저",
    image: null,
  },
  {
    id: 8,
    ...
    product: "냉각 설비",
    substance: "에틸렌글리콜",
    exposure: "액체 접촉 및 오인 섭취",
    toxicity: "신장 독성/생식 독성",
    risk: 2,
    action: "소분 용기 경고 표지 부착 및 MSDS 교육 실시",
    image: null,
  },
  {
    id: 9,
    ...
    toxicity: "두통/어지러움 유발",
    risk: 1,
    action: "밀폐 공간 사용 금지 및 환기 양호 상태 유지",
    image: null,
  },
]
...
export const checklistMockData: ChecklistSection[] = [
  {
    title: "물질 유해성",
    downloadKey: "hazardous-substance",
    items: [
      "현재 취급하고 있는 물질보다 독성이 적은 물질로 대체 가능한가?",
      "현재 물질의 물리적 성질을 고려하여 비가연성 물질로 대체가 가능한가?",
      "현재 유해물질 취급 공정의 완전 밀폐 또는 폐쇄가 가능한가?",
    ],
  },
  {
    title: "물질노출 가능성",
    downloadKey: "exposure-possibility",
    items: [
      "현재 사용하고 있는 화학물질의 사용량(취급량)을 줄일 수 있는가?",
      "공정 변경을 통해 물질의 누출 가능성을 근본적으로 줄였는가?",
      "대상 유해물질 발생원에 대한 국소 밀폐가 가능한가?",
      "유해물질 취급 시 분진의 재비산 최소화가 가능한가?",
      "국소배기장치/후드 설치를 통해 유해물질 노출 농도 감소가 가능한가?",
      "후드 흡입구를 오염원(발생원)에 더 가깝게 위치시킬 수 있는가?",
      "관리감독자에 의한 정기적인 점검(누출 여부 등)이 수행되고 있는가?",
    ],
  },
  {
    title: "작업방법",
    downloadKey: "work-method",
    items: [
      "유해물질 취급 공정을 타 공정 및 일반 작업장소와 격리할 수 있는가?",
      "오염원 확산 방지를 위한 차단벽(커튼 등) 설치가 가능한가?",
      "유해물질 취급 작업을 자동화 또는 로봇 공정으로 변경 가능한가?",
      "유해물질 용기를 지정된 별도 저장소에 보관하고 시건장치 하였는가?",
      "작업 시작 전 설비 및 보호구 점검이 절차대로 이행되는가?",
    ],
  },
  {
    title: "관리방안",
    downloadKey: "management-plan",
    items: [
      "취급 근로자에 대한 특수건강검진을 주기적으로 실시하고 있는가?",
      "작업환경측정을 정기적으로 실시하고 노출기준을 준수하는가?",
      "해당 화학물질의 유해성(MSDS)에 대해 근로자 교육을 실시하였는가?",
      "물질 특성에 맞는 적정 보호구(호흡기, 피부)가 지급되었는가?",
      "작업 중 근로자가 지급된 보호구를 올바르게 착용하고 있는가?",
    ],
  },

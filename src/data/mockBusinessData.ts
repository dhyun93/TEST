...
export const inspectionItemsMockData: InspectionItem[] = [
  // 2026년 데이터 (5개, 분기 체크 있음)
  {
    ...
    department: "전부서",
    achievementRate: "50",
    resultRemark: "1,3분기 실시 예정",
    entryDate: "2026-01-05",
  },
  {
    id: 2,
    year: "2026",
    detailPlan: "안전보건교육(정기)",
    q1: true,
    q2: true,
    q3: true,
    q4: true,
    ...
    department: "전부서",
    achievementRate: "25",
    resultRemark: "분기별 3시간 교육",
    entryDate: "2026-01-10",
  },
  {
    id: 3,
    year: "2026",
    detailPlan: "산업안전보건위원회",
    q1: true,
    q2: true,
    q3: true,
    q4: true,
  ...
  },
  {
    ...
    department: "전부서",
    achievementRate: "0",
    resultRemark: "2,4분기 훈련 예정",
    entryDate: "2026-01-20",
  },
  {
    id: 5,
    year: "2026",
    detailPlan: "소방시설 정기점검",
    q1: true,
    q2: true,
    q3: true,
    q4: true,
...
export const budgetItemsMockData: BudgetItem[] = [
  // 2026년 1분기
  {
    ...
    year: "2026",
    quarter: 1,
    itemName: "사출기 안전장치 점검",
    category: "로열제리 박스 생산라인",
    budget: "15000000",
    spent: "8500000",
    remaining: "6500000",
    carryOver: false,
  ...
  },
  {
    ...
    year: "2026",
    quarter: 1,
    itemName: "프레스 작업 안전교육",
    category: "산업용제품 내장재 생산",
    budget: "8000000",
    spent: "6000000",
    remaining: "2000000",
    carryOver: false,
  ...
  },
  {
    ...
    year: "2026",
    quarter: 1,
    itemName: "화학물질 취급 보호구",
    category: "친환경부표 40L 생산",
    budget: "12000000",
    spent: "9000000",
    remaining: "3000000",
    carryOver: false,
  ...
  },
  {
    ...
    year: "2026",
    quarter: 2,
    itemName: "소음 저감 설비 도입",
    category: "허니빌 1상2왕 생산",
    budget: "18000000",
    spent: "10000000",
    remaining: "8000000",
    carryOver: false,
  ...
  },
  {
    ...
    year: "2026",
    quarter: 3,
    itemName: "자동화 로봇 안전펜스",
    category: "자동차 부품 포장재 생산",
    budget: "35000000",
    spent: "20000000",
    remaining: "15000000",
    carryOver: false,
  ...
  },
  {
    ...
    year: "2026",
    quarter: 4,
    itemName: "차년도 안전장비 구매",
    category: "2027년 안전설비 사전구매",
    budget: "45000000",
    spent: "0",
    remaining: "45000000",
    carryOver: true,
  ...
  },
  {
    ...
    year: "2025",
    quarter: 4,
    itemName: "차년도 보호구 사전구매",
    category: "2026년 보호구 구매",
    budget: "20000000",
    spent: "20000000",
    remaining: "0",
    carryOver: false,
...
export const organizationMockData: DataRow[] = [
  { id: 1, name: "박대표", safetyPosition: "경영책임자", subject: "경영지원팀", rank: "대표이사", phone: "010-1234-5678", employment_date: "-", designated_date: "2022-01-10" },
  { id: 2, name: "최책임", safetyPosition: "안전보건관리책임자", subject: "생산관리팀", rank: "부장", phone: "010-3333-7777", employment_date: "2025-05-10", designated_date: "2022-03-10" },
  { id: 3, name: "박안전", safetyPosition: "안전관리자", subject: "안전관리팀", rank: "과장", phone: "010-8888-1234", employment_date: "2025-08-15", designated_date: "2020-09-01" },
  { id: 4, name: "이보건", safetyPosition: "보건관리자", subject: "보건팀", rank: "주임", phone: "010-5555-4321", employment_date: "2025-11-20", designated_date: "2019-12-10" },
  { id: 5, name: "김반장", safetyPosition: "관리감독자", subject: "생산1팀", rank: "반장", phone: "010-1111-2222", employment_date: "2025-01-15", designated_date: "2023-02-01" },
  { id: 6, name: "조반장", safetyPosition: "관리감독자", subject: "생산2팀", rank: "반장", phone: "010-3333-4444", employment_date: "2025-06-12", designated_date: "2022-07-01" },
  { id: 7, name: "이영수", safetyPosition: "관리감독자", subject: "설비보전팀", rank: "반장", phone: "010-5555-6666", employment_date: "2025-03-18", designated_date: "2021-04-01" },
]
...
export const budgetMockData: DataRow[] = [
  {
    id: 1,
    year: "2026",
    itemName: "슬래그 밀 정비 특화 안전 장비 구입",
    category: "밀폐/고소 작업 안전 장비 확보",
    budget: "50000000",
    spent: "3000000",
    remaining: "47000000",
    carryOver: true,
  ...
  },
  {
    id: 2,
    year: "2025",
    itemName: "유압 설비 안전 진단 용역",
    category: "유압 라인 및 어큐뮬레이터 정기 점검",
    budget: "30000000",
    spent: "28000000",
    remaining: "2000000",
    carryOver: false,
    attachment: "용역계약서.pdf",
    author: "이설비",
    entryDate: "2025-01-15",
  },
  {
    id: 3,
    year: "2025",
    itemName: "중대재해 비상 대응 훈련 (4분기)",
    category: "가상 시나리오 기반 전사 훈련",
    budget: "25000000",
    spent: "25000000",
    remaining: "0",
    carryOver: false,
  ...
  },
  {
    id: 4,
    year: "2025",
    itemName: "협력업체 안전보건 컨설팅 비용",
    category: "협력업체 위험성평가 및 교육 지원",
    budget: "15000000",
    spent: "15000000",
    remaining: "0",
    carryOver: false,
    attachment: "컨설팅계약.pdf",
    author: "정안전",

...
export default function NoticeRegister({ isOpen, onClose, onSave, userName, isEdit, initialData }: Props): React.ReactElement | null {
    ...
    <div className={DIALOG_STYLES.overlay}>
      <div className={DIALOG_STYLES.containerLg}>
        <div className={DIALOG_STYLES.header}>
          <h2 className={DIALOG_STYLES.title}>공지사항 {isEdit ? "편집" : "등록"}</h2>
